        ...
        xmlhttp.onreadystatechange = function receiveResponse() {
            if (this.readyState == 4) {
                if (this.status == 200) {
                    ...
                    alert("New network configuration received, system rebooting\nConnect your device to the same network and ask Alexa for IP address to get access.\nNetwork configuration received, system is now rebooting.\nConnect your device to the same network and ask Alexa for IP address to get access.\nYou can say: \"Alexa, ask network address\"\n\nIf some problem happen repeat the process connecting to Alexa-AP network.y: \"Alexa, ask network address\"\n\nIf some problem happen repeat the process connecting to Alexa-AP network.");
