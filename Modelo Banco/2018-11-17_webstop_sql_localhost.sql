...
--
-- Host: 127.0.0.1
-- Generation Time: 17-Nov-2018 às 20:03
...
INSERT INTO `resposta` (`idresposta`, `nome`, `cidade`, `animal`, `fruta`, `cor`, `profissao`, `carro`, `filme`, `user_iduser`, `partida_idpartida`) VALUES
(1, '', '', '', '', '        ', '', '', '', 12, 18),
(2, '', '', '', '', '        ', '', '', '', 12, 16),
(3, '', '', '', '', '        ', '', '', '', 12, 17),
(4, '', '', '', '', '        ', '', '', '', 12, 17),
(5, 'emerson', '', '', '', '        ', '', '', '', 12, 18),
(6, 'emerson', 'sdasda', 'asdasd', '', '        ', '', '', '', 12, 18),
(7, 'emersona', 'asda', 'asda', 'asda', '        asdas', 'asda', 'asda', 'asda', 12, 16),
(8, 'asdasd', 'asdas', 'asdas', '', '        ', '', '', '', 13, 42),
(9, 'sdasd', 'asdasd', 'asdasd', 'asd', '        asdas', 'asdas', 'aasda', 'asdasd', 12, 42);
...
--
ALTER TABLE `partida`
  MODIFY `idpartida` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
--
